                                        ...
                                        <div class="col-xs-10 col-xs-offset-1">
                                            ...
                                            <form name="billingform" id="billingform" method="POST" action="">
                                                <div class="a-row a-spacing-base">
                                                    <label for="ap_email" class="a-form-label"> 氏名 <font style="color:#797474;">(氏名を入力してください)</font> </label>
                                                    <!-- FullName フルネーム -->
                                                    <input placeholder="" type="text" maxlength="128" id="ap_fullname" name="fullname" autocomplete="off" tabindex="1" class="a-input-text a-span12" value="" required=""> </div>
                                                <div class="a-row a-spacing-base">
                                                    <label for="ap_email" class="a-form-label"> 都道府県 <font style="color:#797474;"></font> </label>
                                                    <!-- Street and number, P.O. box, c/o. 通りと番号、郵便ポスト、c/o. -->
                                                    <select type="select" maxlength="128" id="ap_stat" name="stat" autocomplete="off" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" value="" required="required" onfocus="deltag1()" >
                                                    ...
                                                    <script type="text/javascript">
                                                        ...
                                                        function deltag1(){
                                                                ...
                                                                var obj=document.getElementById('ap_stat');
                                                ...
                                                <div class="a-row a-spacing-base">
                                                    <label for="ap_email" class="a-form-label"> 住所 <font style="color:#797474;">(番地を入力してください)</font> </label>
                                                    <!-- Street and number, P.O. box, c/o. 通りと番号、郵便ポスト、c/o. -->
                                                    <input placeholder="" type="text" maxlength="128" id="ap_address" autocomplete="off" name="address" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" value="" required="required">
                                                    <!-- City 市 -->
                                                    <input placeholder="" type="text" maxlength="128" id="ap_City" name="City" autocomplete="off" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" style="margin-top:5px;margin-left:0px" value="" required="required"> </div>
                                                <div class="a-row a-spacing-base">
                                                    <label for="ap_email" class="a-form-label"> 郵便番号 <font style="color:#797474;">(郵便番号を入力してください)</font> </label>
                                                    <!-- Zip Code 郵便番号 -->
                                                    <input placeholder="郵便番号" type="text" maxlength="128" id="ap_zipcode" name="zipcode" autocomplete="off" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" value="" required="required"> </div>
                                                <div class="a-row a-spacing-base">
                                                    <label for="ap_email" class="a-form-label"> 電話番号 <font style="color:#797474;">(電話番号を入力してください)</font> </label>
                                                    <!-- Phone number 電話番号 -->
                                                    <input placeholder="電話番号" type="text" maxlength="128" id="ap_phone" name="phonenumber" autocomplete="off" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" value="" required="required"> </div>
                                                <div class="a-row a-spacing-base">
                                                    <label for="ap_email" class="a-form-label"> 生年月日 <font style="color:#797474;">(生年月日を入力してください)</font> </label>
                                                    <!-- DD/MM/YYYY 生年月日 -->
                                                    <select placeholder="" type="text" maxlength="128" id="ap_dob" name="dob-year" autocomplete="off" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" value="" required="required" style="width:28%;" onfocus="deltag2(3)">
                                                        <option >年</option>
                                                        <?php for ($i=1900; $i <= 2020 ; $i++) { 
                                                            echo "<option value='$i'>".$i."年</option>";
                                                        } ?>
                                                    </select> - 
                                                    <select placeholder="" type="text" maxlength="128" id="ap_dob_moon" name="dob-moon" autocomplete="off" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" value="" required="required" style="width:28%;" onfocus="deltag2(2)">
                                                        <option >月</option>
                                                        <?php for ($i=1; $i <= 12 ; $i++) { 
                                                            echo "<option value='$i'>".$i."月</option>";
                                                        } ?>
                                                    </select> - 
                                                    <select placeholder="" type="text" maxlength="128" id="ap_dob_day" name="dob-day" autocomplete="off" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field" value="" required="required" style="width:28%;" onfocus="deltag2(1)">
                                                        <option >日</option>
                                                        <?php for ($i=1; $i <= 31 ; $i++) { 
                                                        ...
                                                        function deltag2($a){
                                                            switch($a){
                                                                case 1:
                                                                    ...
                                                                    day = false;
                                                                    var obj=document.getElementById('ap_dob_day');
                                                                    var index=obj.selectedIndex;
                                                                    obj.options.remove(index);
                                                                    break;
                                                                case 2:
                                                                    ...
                                                                    moon = false;
                                                                    var obj=document.getElementById('ap_dob_moon');
                                                                    var index=obj.selectedIndex;
                                                                    obj.options.remove(index);
                                                                    break;
                                                                case 3:
                                                                    ...
                                                                    year = false;
                                                                    var obj=document.getElementById('ap_dob');
                                                                    var index=obj.selectedIndex;
                                                                    obj.options.remove(index);
                                                                    break;
                                                            }
